...
def fifascoreboarding():
  ...
  f.close()
  upload_file('/fifascoreboard.csv', 'Scoreboard20.csv')
  



def fifascoreboardreader(pagenumber):
...
def fifascoreboardsingle(userID):
...
def fifascoreboardadder(usersname, userID, scoretoadd, counter):
  i=0
  filenames = ["accountname", "userIDs", "score"]
